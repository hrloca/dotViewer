...
export const animations: Animation[] = [
  ...
  },
  {
    ...
    loop: false,
    frames: [
      { coordinate: [3, 1], duration: 80 },
      { coordinate: [3, 0], duration: 80, reverse: true },
      { coordinate: [2, 0], duration: 80 },
  ...
  },
  {
    ...
    loop: false,
    transition: [
      { value: { x: 0, y: -100 }, duration: 180, easing: Easing.out(Easing.cubic) },
      { value: { x: 0, y: 0 }, duration: 180, easing: Easing.in(Easing.cubic) },
    ],
    frames: [
      { coordinate: [3, 1], duration: 100 },
      { coordinate: [3, 0], duration: 100, reverse: true },
      { coordinate: [2, 0], duration: 100 },
      { coordinate: [3, 1], duration: 100 },
      { coordinate: [3, 0], duration: 100, reverse: true },
      { coordinate: [4, 1], duration: 100 },
    ],
  },
]
